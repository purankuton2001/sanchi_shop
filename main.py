...
Label(root, text= "Click the button to Open Popup Window", font= ('Helvetica 18')).place(relx=.5, rely=.5, anchor= CENTER)
Button(root, text= "Click Me", background= "white", foreground= "blue", font= ('Helvetica 13 bold'), command=main).pack(pady= 50)
root.mainloop()
main()  # メイン関数を実行
